  ...
  return <div className="page settings-page">
    ...
    <section className="settings-sheet">
      ...
      {tab === "llm" && <>
        ...
        <Field label={`实时字幕首 token 截止 · ${(s.llm.timeout_milliseconds / 1000).toFixed(1)} 秒`} hint="判定时统一容忍 0.5 秒；例如设置 5 秒，5.5 秒内到达的首 token 仍会接受"><input type="range" min="1000" max="5000" step="250" value={Math.min(s.llm.timeout_milliseconds, 5000)} onChange={e => update({ ...s, llm: { ...s.llm, timeout_milliseconds: Number(e.target.value) } })} /></Field>
